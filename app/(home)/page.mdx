...
<h3 className="mb-4 mt-5">Core Reasoning</h3>
...
| ------------------------------------ | -------------------------------------------------------------------- | ---------- | ------- |
| [talos](https://talos.rroessler.io/) | A forward-thinking, programming language that puts developers first. | 2026-03-06 | 0.1.2   |
